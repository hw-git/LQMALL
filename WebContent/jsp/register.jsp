...
font {
 ...
 <script type="text/javascript" >
 	$(function(){
 		//更换验证码
 		$("#code").click(function(){
 			this.src="${pageContext.request.contextPath}/codeServlet?"+new Date().getTime();
 		});
 		//异步验证用户名是否已经存在
 		//为用户名文本框绑定一个事件  失去焦点事件
		...
		<form class="form-horizontal" style="margin-top:5px;" method="post" action="${pageContext.request.contextPath }/userServlet?method=regist">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			    <img id="code" src="${pageContext.request.contextPath}/codeServlet"/>
			    </div>
